...
def main(args: argparse.Namespace) -> None:
    ...
    for bs in args.batch_sizes:
        ...
        os.system(
            f"python train.py --profile True --profile_path {profile_path} --epochs {args.epochs} --batch_size {bs} --power_limits {power_limits} --warmup_steps {args.warmup_steps} --profile_steps {args.profile_steps}"
        )
